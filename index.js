        ...
        try {
            ...
            for (const plugin of handlerPlugins) {
                ...
                try {
                    ...
                    if (match) {
                        await plugin(m, {
                            conn, args, q, usedPrefix: prefix, command,
                            isOwner, isAdmin: isAdmins, isBotAdmin: isBotAdmins,
                            isROwner: isOwner, from, reply
                        });
                    }
                } catch (e) {
                ...
                try {
                    ...
                    if (match) {
                        ...
                        await cmd.function(conn, m, m, {
                            from, quoted: m.quoted, body, isCmd: true, command, args, q,
                            isGroup, sender, senderNumber, botNumber2: botNumber, botNumber,
                            botLid, pushname, isMe, isOwner, groupMetadata, groupName,
